...
//
// Method1:
// 1) Download the code to a 'F70x device that is connected as above.
...
//
// Method2 (optional):
// 1) Download code to a 'F70x device that is connected as above
...
void main (void)
{
   ...
   S8  test_byte;                     // Used as a temporary variable
