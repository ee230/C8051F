...
// How To Test:
//
// 1) Open the F99x_Timer2_two_8bitTimers.c file in the Silicon Labs IDE.
// 2) If necessary change the number of interrupts to toggle an output:
//    YELLOW_TOGGLE_RATE
//    RED_TOGGLE_RATE
// 3) Compile and download the code.
// 4) Verify the LED pins of J8 are populated on the 'F99x TB.
// 5) Run the code.
...
void Port_Init (void)
{
   ...
   P1MDOUT = 0x28;                        // Set LEDs to be used as push-pull
}
