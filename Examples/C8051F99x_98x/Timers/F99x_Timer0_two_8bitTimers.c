...
// How To Test:
//
// 1) Open the F99x_Timer0_two_8bitTimers.c file in the Silicon Labs IDE.
// 2) If desired, change the number of interrupts (ms) to toggle an output:
//    LED_TOGGLE_RATE
//    SIGNAL_TOGGLE_RATE
// 3) Compile and download the code.
// 4) Verify the LED pin of J8 are populated on the 'F99x TB.
...
SBIT (YELLOW_LED, SFR_P1, 3);          // YELLOW_LED == 0 means ON
...
//
// P1.3   digital   push-pull   Yellow LED (toggled by TL0)
...
void Port_Init (void)
{
   ...
   P1MDOUT = 0x28;                     // Set LED's to push-pull
}
