...
// How To Test:
//
// 1) Download code to a 'F99x target board with the LED jumper ON.
...
#define LED_FREQUENCY 240L               // Frequency to blink LED at in Hz
...
SBIT (LED1, SFR_P0, 1);                 // LED==1 means ON
SBIT (LED2, SFR_P0, 2);                 // LED==1 means ON
SBIT (LED3, SFR_P0, 3);                 // LED==1 means ON
SBIT (LED4, SFR_P0, 4);                 // LED==1 means ON
