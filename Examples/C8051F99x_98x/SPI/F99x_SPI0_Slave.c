...
// How To Test:
//
// 1) Download the code to a F99x-TB that is connected as above to
//    another device running the SPI0_Master code.
// 2) Verify that the J13 and J14 jumpers are not populated.
// 3) Verify the Yellow LED pin (P1.3) of jumper J8 is populated.
// 4) Run the code.
...
SBIT (LED, SFR_P1, 3);                 // LED==LED_ON means ON
