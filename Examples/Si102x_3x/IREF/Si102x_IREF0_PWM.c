...
// maximum current is 63uA. When R36 is populated with a 3.92 kOhm resistor,
// the voltage on P0.7/IREF0 should vary between 0V and 0.247V. To keep the
...
// current is 504uA. In this mode, the voltage should vary between 0V and
// 1.976V when a 3.92 kOhm resistor is used at the IREF0 output.
//
// Pinout:
//
// P0.0 - SW1
...
// How To Test:
//
// 1) Compile and download code to an Si102x/3x device on a UPMP-F960-MLCD
//    development board.
// 2) Ensure that R36 and C7 are populated and that a shorting
//    block is installed between pin 1 and 2 of J19.
// 3) Place voltmeter or oscilloscope on P0.7/IREF0.
// 4) To hold the voltage/current at its current value, press the
//    P0.2 Switch.
//
// Target:         Si102x/3x
// Tool chain:     Generic
...
#ifdef UDP_F960_MCU_EMIF
#warning "Populate zero ohm resistors to connect IREF resistor to P0.7."
#endif
//-----------------------------------------------------------------------------
// Global Constants
//-----------------------------------------------------------------------------
