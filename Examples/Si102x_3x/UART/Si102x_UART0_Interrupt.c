...
// Program Description:
//
// This program demonstrates how to configure the Si102x/3x to write to and
...
// How To Test:
//
// 1) Ensure that jumpers are placed on P2 of the UPMP-F960-MLCD development
//    board that connect P0.4 to MCU_TX and P0.5 to MCU_RX.
// 2) Connect a USB cable from the development board to a PC
// 3) Specify the baudrate in the constant <BAUDRATE>
// 4) Open Hyperterminal, or a similar program, and connect to the target
//    board's USB port (virtual com port)
// 5) Download and execute code on the development board
