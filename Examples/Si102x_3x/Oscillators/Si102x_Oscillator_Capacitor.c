...
//
//
// Testing prcedure using an Si102x/3x device on a UPMP-F960-MLCD:
//
// 1) Connect a 33pF capacitor between P0.3/XTAL2 and ground.
// 2) Specify the target frequency in the constant <C_FREQUENCY>.
// 3) Download code to a target board.
