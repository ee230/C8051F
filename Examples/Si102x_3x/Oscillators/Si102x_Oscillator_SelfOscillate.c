//-----------------------------------------------------------------------------
// Si102x_Oscillator_SelfOscillate.c
//-----------------------------------------------------------------------------
...
// Program Description:
//
// This program demonstrates how to use the Self-Oscillate mode of
...
void PORT_Init (void)
{
   ...
   P1MDIN &= ~0x0C;                    // P1.2 & P1.3 configured for analog in
...
// to operate using the Self-Oscillate mode. Lastly it enables the alarm
...
void RTC_Init (void)
{
   ...
   RTC_Write (RTC0XCN, 0x00);          // This is the default value for this
                                       //   register. XMODE = 0, BIASX2 = 0.
