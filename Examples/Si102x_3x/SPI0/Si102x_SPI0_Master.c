...
// Program Description:
//
// This program configures an Si102x/3x as a 4-wire SPI Single Master.
//
...
//    SPI0_Slave code.
// 2) Run the code.
// 3) If the communication passes, LED1 on both the Master and Slave
//    boards will blink slowly. If it fails, LED1 will be OFF.
//
//
// Target:         Si102x/3x
// Tool chain:     Generic
...
SBIT (LED1, SFR_P0, 0);                // LED==LED_ON means ON
