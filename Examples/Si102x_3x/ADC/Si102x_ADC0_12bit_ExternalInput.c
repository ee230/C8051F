//-----------------------------------------------------------------------------
// Si102x_ADC0_12bit_ExternalInput.c
//-----------------------------------------------------------------------------
...
//
// When pin 1 and 2 of J18 are shorted, the potentiometer (R34) wiper is
// connected to P0.6. When J18 is open, P0.6 may also be supplied with an
// external voltage. 
//
...
// 5) Connect a variable voltage source to P0.6 or verify that pin 1 and 2 of
//    J18 are shorted.
