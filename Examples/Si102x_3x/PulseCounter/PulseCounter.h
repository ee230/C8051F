...
//
// This file is Pulse Counter header file for the Si102x/3x.
//
// Target:
//    Si102x/3x
//
...
U8    PC0_SetDebounceTimeHigh (U32);
U8    PC0_SetDebounceTimeLow (U32);
U32   PC0_SetPullUpCurrent (U32);
