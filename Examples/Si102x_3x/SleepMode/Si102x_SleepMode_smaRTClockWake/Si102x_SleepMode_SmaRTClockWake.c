//-----------------------------------------------------------------------------
// Si102x_SleepMode_SmaRTClockWake.c
//-----------------------------------------------------------------------------
...
// Program Description:
//
// This program flashes the LED2 on the UPMP-F960-MLCD board about
// five times a second using the interrupt handler for Timer2 when the
// MCU is awake.
//
// The SmaRTClock is configured to generate a wake-up event every 5 seconds.
// The device will toggle between Sleep/Suspend mode and Normal mode.
//
//
// How To Test:
//
// 1) Download code to the UPMP-F960-MLCD board
// 2) LED2 is off for about 5 seconds.
// 3) LED2 blinks for about 5 seconds.
