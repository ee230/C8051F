...
// four bytes of the last Flash page. The final resulting CRC should be 0.
//
...
// 2) Download code to an Si102x/3x device on a UPMP-F960-MLCD development
//    board.
// 3) Run the program.  If LED1 is ON, the program is working.
//                      If LED2 is ON, a CRC error was detected.
