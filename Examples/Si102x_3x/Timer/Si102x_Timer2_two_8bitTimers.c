//-----------------------------------------------------------------------------
// Si102x_Timer2_two_8bitTimers.c
//-----------------------------------------------------------------------------
...
// Pinout:
//
//    P0.0 -> LED1 (toggled by TMR2L)
//    P0.1 -> LED2 (toggled by TMR2H)
//
...
// 4) Run the code.
// 6) Verify that the LEDs are blinking at the appropriate rates.
//
// Target:         Si102x/3x
// Tool chain:     Generic
// Command Line:   None
...
#define LED1_TOGGLE_RATE           30     // LED1 toggle rate in milliseconds.
                                          // If LED1_TOGGLE_RATE = 1, LED2 will
                                          // be on for 1 millisecond and off for
                                          // 1 millisecond.
