...
// Program Description:
//
// This program presents an example of use of the Timer0 in 16-bit
// counter/timer mode. It runs on an Si102x/3x device on the UPMP-F960-MLCD
// development board. In this example the LED is toggled at a rate defined by
//  the LED_TOGGLE_RATE constant.(in milliseconds)
//
...
// 2) If a different rate is required, change LED_TOGGLE_RATE (in msec).
