...
// Program Description:
//
// This program accesses a SPI EEPROM using polled mode access. The 'F12x MCU 
...
// connections of the 'F12x MCU are shown here:
// 
...
//
// Method1:
// 1) Download the code to a 'F12x device that is connected as above.
...
//
// Method2 (optional):
// 1) Download code to a 'F12x device that is connected as above, and 
...
//-----------------------------------------------------------------------------
// 16-bit SFR Definitions for the 'F12x
//-----------------------------------------------------------------------------
