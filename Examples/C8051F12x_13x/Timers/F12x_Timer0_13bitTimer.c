...
// Program Description:
//
// This program presents an example of use of the Timer0 of the C8051F12x's
// in 13-bit counter/timer mode. It uses the 'F120DK as HW platform and blinks
...
// follow these steps:
//
// 1) Open the F12x_Timer0_13bitTimer.c file in the Silicon Labs IDE.
// 2) If a different LED blink rate is required change the following constant:
//       -> LED_TOGGLE_RATE in milliseconds
// 3) Compile and download the code to a 'F12x
...
void Timer0_Init(void)
{
   ...
   TH0 = TIMER0_RELOAD_HIGH;           // Reinit Timer0
   TL0 = TIMER0_RELOAD_HIGH;
