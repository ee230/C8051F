...
//
// The maximum square wave frequency output for this example is about 480 kHz.
// The minimum square wave frequency output for this example is about 380 Hz
//
// The PCA time base in this example is configured to use SYSCLK, and SYSCLK
// is set up to use the internal oscillator multiplied by 2 running at 24.5
// MHz (49 MHz). Using different PCA clock sources or a different processor
// clock will  result in a different frequency for the square wave, and
// different maximum and minimum options.
//
//    -------------------------------------------------------------------------
