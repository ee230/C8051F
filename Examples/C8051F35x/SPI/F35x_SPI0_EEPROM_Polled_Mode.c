...
//
// Method1:
// 1) Download the code to a 'F35x device that is connected as above.
...
//
// Method2 (optional):
// 1) Download code to a 'F35x device that is connected as above, and 
...
//-----------------------------------------------------------------------------
// 16-bit SFR Definitions for the 'F35x
//-----------------------------------------------------------------------------
