...
// Program Description:
//
// This program configures a C8051F35x as a 4-wire SPI Single Master.
//
...
// How To Test:
//
// 1) Download the code to a F350-TB that is connected as above to
//    another device running the SPI0_Slave code.
// 2) Verify the LED pins of jumper J3 are populated.
// 3) Verify that the J9 and J10 shorting blocks are installed
// 4) Run the code.
