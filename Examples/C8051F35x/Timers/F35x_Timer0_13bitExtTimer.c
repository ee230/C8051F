...
// How To Test:
//
// 1) Open the F35x_Timer0_13bitExtTimer.c file in the Silicon Labs IDE.
// 2) To change the number of input pulses/interrupt, modify
//    PULSES_PER_TOGGLE.
// 3) To change the speed of the SIGNAL waveform, modify
//    SOFTWARE_DELAY
// 4) Compile the project
// 5) Download code to a 'F35x device
// 6) Verify J9, J10 are populated, as well as the LED and switch pins of J3,
//    on the 'F35x TB.
// 7) Connnect the following pins:
//
//                   P0.0 <--> P0.3 (T0 with SIGNAL)
...
sbit SIGNAL = P0^3;                    // SIGNAL is used to input pulses into
                                       // T0 pin
sbit BUTTON1 = P1^0;                   // Button that enables counting
