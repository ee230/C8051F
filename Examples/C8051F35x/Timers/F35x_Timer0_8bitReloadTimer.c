...
// How To Test:
//
// 1) Load the F35x_Timer0_8bitReloadTimer.c file in the Silicon Labs IDE.
// 2) If a different LED blink rate is required change the following constant:
//       -> LED_TOGGLE_RATE in milliseconds
// 3) Compile and download code to a 'F35x device
// 4) Verify the LED pins of J3 are populated on the 'F35x TB.
// 5) Run the code
// 6) Check the toggling of the LED1
//
//
// FID:            F35x_Timer0_8bitReloadTimer.c
// Target:         C8051F35x
