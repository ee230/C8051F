...
// Program Description:
//
// This program demonstrates how to configure the C8051T620 to write to and
...
// 5) Download and execute code on an 'T620 device on a 'T62x mother board.
