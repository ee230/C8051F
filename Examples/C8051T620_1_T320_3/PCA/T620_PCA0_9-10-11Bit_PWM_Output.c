//-----------------------------------------------------------------------------
// T620_PCA0_9-10-11Bit_PWM_Output.c
//-----------------------------------------------------------------------------
...
// 2) Download code to a 'T620 device on a 'T62x mother board which has an
//    oscilloscope monitoring P0.0.
...
#define BIT_MODE 9
   ...
   #define  DELAY 6000                 // Arbitrary delay so the waveform is
                                       // smooth
...
void PCA0_Init (void)
{
   ...
   PCA0PWM = PWM_MODE;                 // Sets PWM mode according to BIT_MODE
                                       // Auto-Reload Registers are also
                                       // enabled
