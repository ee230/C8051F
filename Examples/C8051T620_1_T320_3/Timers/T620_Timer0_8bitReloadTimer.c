...
// 8-bit counter/timer with reload mode. It uses the 'T620 daughter card and
...
// How To Test:
//
// 1) Load the T620_Timer0_8bitReloadTimer.c file in the Silicon Labs IDE.
...
// 4) Verify the LED pins of J10 are populated on the 'T62x MB.
// 5) Run the code.
