...
#include "T620_USB0_Register.h"
#include "T620_USB0_InterruptServiceRoutine.h"
#include "T620_USB0_Descriptor.h"
#include "T620_USB0_ReportHandler.h"
...
// Return Value : None
// Parameters   :
//                1) unsigned char addr : target address
//                2) unsigned int uNumBytes : number of bytes to unload
//                3) unsigned char * pData : read data destination
//
...
//                1) unsigned char addr : target address
//                2) unsigned int uNumBytes : number of bytes to unload
//                3) unsigned char * pData : location of source data
//
...
// an ISR.  This stops any chance that the function could be called twice
// at the same time, corrupting data.
//
//-----------------------------------------------------------------------------
void Fifo_Write_Foreground (unsigned char addr,
