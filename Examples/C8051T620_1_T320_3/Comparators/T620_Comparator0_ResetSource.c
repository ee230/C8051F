//-----------------------------------------------------------------------------
// T620_Comparator0_ResetSource.c
//-----------------------------------------------------------------------------
...
// How To Test:
//
// 1) Compile and download code to a 'T620 device on a 'T62x development board.
...
SBIT (LED, SFR_P2, 2);                 // Green Led
SBIT (SWITCH, SFR_P2, 0);              // Push-button switch on board
