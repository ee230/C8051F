...
// 2) Compile and download code to a 'T620 device.
// 3) Connect the CMOS input clock to XTAL2 / P0.3 using either the port header
//    on the Target Board or the crystal test points on the daughter card.
// 4) Run the code:
//      - the test will blink an LED at a frequency based on the CMOS
//         Oscillator
//      - the 'T620 will also output the SYSCLK to a port pin (P0.0) for
//         observation
//
//
