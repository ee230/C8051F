...
//
// FID
// Target:         C8051T620/1, C8051T320/1/2/3
...
//    -All changes by BW
//    -1 SEP 2010
//    -Updated sysclk init comments
// Release 1.0
//    -11 SEP 2008 (TP)
//    -Modified for C8051T620/1, C8051T320/1/2/3
//
// Release 1.0
//    -Initial Revision (PD)
//    -04 JUN 2008
...
//
//-----------------------------------------------------------------------------
INTERRUPT(UART0_Interrupt, INTERRUPT_UART0)
{
//   DEBUG_UART = 1;
...
// Parameters - None
//
// This function is declared in the header file F3xx_HIDtoUART.h and is called
// in the main(void) function.  It calls initialization routines local to this
// file.
//
//-----------------------------------------------------------------------------
...
void Port_Init (void)
{
   P0MDOUT |= 0x10;                    // P0.4 (TX) set to push-pull
