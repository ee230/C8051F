...
// Program Description:
//
// Example software to demonstrate the C8051T620/1 SMBus interface in
...
//      - the 'T620/1 SMBus master should detect any conflict using ARBLOST
//      - the 'T620/1 SMBus master should give up the bus, if necessary, and
//        switch to slave receiver mode
//      - the 'T620/1 SMBus master should transmit after the other master is
//        done
// - Pinout:
//    P0.0 -> SDA (SMBus)
//    P0.1 -> SCL (SMBus)
...
// How To Test:
//
// 1) Download code to a 'T620 device on a 'T62x mother board that is connected
...
//
//      'T620 Multimaster                    Other C8051Fxxx/Txxx Multimaster
//         LED (blinks) <------------------------------ Switch
//              SW --------------------------------> LED (blinks)
//
...
SBIT (SW, SFR_P2, 0);                  // Switch on P2.0

SBIT (LED, SFR_P2, 2);                 // LED on port P2.2
