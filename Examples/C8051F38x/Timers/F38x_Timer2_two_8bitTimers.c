...
// How To Test:
//
// 1) Open the F38x_Timer2_two_8bitTimers.c file in the Silicon Labs IDE
// 2) If necessary change the number of interrupts to toggle an output:
//    LED1_TOGGLE_RATE
//    LED2_TOGGLE_RATE
// 3) Compile and download the code
// 4) Verify the LED pins of J12 are populated on the 'F38x TB.
// 5) Run the code
// 6) Verify that both LEDs are blinking at the proper frequencies.
//
//
// Target:         C8051F38x
