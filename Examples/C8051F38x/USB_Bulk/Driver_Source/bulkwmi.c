...
--*/
{
    ...
    KdPrint( ("BulkUsb_QueryWmiDataBlock - begins\n"));
    ...
    KdPrint( ("BulkUsb_QueryWmiDataBlock - ends\n"));
...
--*/
{
    ...
    KdPrint( ("BulkUsb_SetWmiDataItem - begins\n"));
    ...
    KdPrint( ("BulkUsb_SetWmiDataItem - ends\n"));
...
--*/
{
    ...
    KdPrint( ("BulkUsb_SetWmiDataBlock - begins\n"));
    ...
    KdPrint( ("BulkUsb_SetWmiDataBlock - ends\n"));
