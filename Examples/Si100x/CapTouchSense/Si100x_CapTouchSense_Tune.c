...
// How To Test:
//
// 1) Ensure that jumpers are placed on J12 of the target board
...
// 5) Download and execute code on an a target board.
// 6) Touch the "Touch Sense Switch" connected to P0.6 and see
...
#define SW06_THRESHOLD  1000           // Threshold for SW06


//-----------------------------------------------------------------------------
// Global Variables
//-----------------------------------------------------------------------------
// Timer2 count of SW06 relaxation oscillator transitions
UU16 SW06_Timer_Count;                     
...
void main (void)
{
   ...
   while(1)
   {
      ...
      printf("\rSW06: %5d",  SW06_Timer_Count.U16 );
...
{  
   ...
   SW06_Timer_Count.U16 = timer_count_B.U16 - timer_count_A.U16;
...
void TouchSense_Init (void)
{
   ...
   CPT0MX = 0xC3;                      // Positive Mux: P0.6 - TouchSense Switch
...
// P0.6   analog    open-drain    Touch Sense Switch
...
void PORT_Init (void)
{
   ...
   P0MDOUT &= ~0x40;                   // P0.6 is open-drain
   P0      |=  0x40;                   // P0.6 latch -> '1'
