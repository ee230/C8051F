...
//      - the 'F06x SMBus master should detect any conflict using ARBLOST
//      - the 'F06x SMBus master should give up the bus, if necessary, and
//        switch to slave receiver mode
//      - the 'F06x SMBus master should transmit after the other master is done
// - Pinout:
//    P0.0 -> SDA (SMBus)
//    P0.1 -> SCL (SMBus)
//
...
// How To Test:
//
// 1) Download code to a 'F06x device that is connected to another C8051Fxxx
//    SMBus multimaster.
...
//
//      'F06x Multimaster                     Other C8051Fxxx Multimaster
//         LED (blinks) <------------------------------ Switch
//              SW --------------------------------> LED (blinks)
//
