...
// and outputs.  The C8051F060 target board has one push-button switch 
...
//
// The program also monitors P5.0.  If P5.0 is high, it sets P5.1 low.  If
// P5.0 is low, P5.1 is set high.  The purpose of this part of the program
...
// 4) Set P5.0 high and low using an external connection and check that
//    the output on P5.1 is the inverse of P5.0.  This needs to be checked
//    on the 96-pin connector
//
//
// FID:            06X000002
// Target:         C8051F06x
...
sbit INPUT1  = P5^0;                   // port pin 5.0
sbit OUTPUT1 = P5^1;                   // port pin 5.1
...
// P5.0   digital   open-drain    Input 1
// P5.1   digital   push-pull     Output 1
//-----------------------------------------------------------------------------
void PORT_Init (void)
{
   char SFRPAGE_SAVE = SFRPAGE;        // Save Current SFR page
   ...
   P5MDOUT = 0x02;                     // P5.0 is open-drain; P5.1 is push-pull
   P5      = 0x01;                     // Set P5.1 latch to '1'
