...
// Pinout:
//
//   P0.2 - LED on T606 (push-pull)
//   P0.6 - LED on T600/1/2/3/4/5 (push-pull)
//
...
// 1) Download code to a 'T60x target board with the LED jumper ON.
...
//
// LED is set to Push-Pull mode.
// (P0.2 for T606)
// (P0.6 for T600/1/2/3/4/5)
//
//-----------------------------------------------------------------------------
void Port_Init (void)
{
