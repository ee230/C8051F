...
// Program Description:
//
// Register/bit definitions for the C8051T60x family.
// **Important Note**: The compiler_defs.h header file should be included
// before including this header file.
//
// Target:         C8051T600, 'T601, 'T602, 'T603, 'T604, 'T605, 'T606
// Tool chain:     Generic
// Command Line:   None
//
// Release 1.3 - 03 NOV 2008 (BD)
//    - added 'T606 to comments.
//    - removed bit-addressable bits that do not exist on this device.
...
// Release 1.1 - 7 FEB 2007 (BD)
//    -Changed TOFFL and TOFFH - addresses were backwards.
// Release 1.0 - (BD)
//    -Initial Release
...
#ifndef C8051T600_DEFS_H
#define C8051T600_DEFS_H
...
SFR (TOFFL, 0xA2);                     // Temperature Sensor Offset Low
SFR (TOFFH, 0xA3);                     // Temperature Sensor Offset High
...
SFR (ADC0LTL, 0xC5);                   // ADC0 Less-Than Compare Low
SFR (ADC0LTH, 0xC6);                   // ADC0 Less-Than Compare High
SFR (REG0CN, 0xC7);                    // Regulator Control
...
SFR16 (TOFF, 0xA2);                    // Temperature Sensor Offset
SFR16 (ADC0_16, 0xBD);                 // ADC0 Data
SFR16 (ADC0GT_16, 0xC3);               // ADC0 Greater-Than Compare
SFR16 (ADC0LT_16, 0xC5);               // ADC0 Less-Than Compare
