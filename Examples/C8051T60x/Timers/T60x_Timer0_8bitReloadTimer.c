...
// 8-bit counter/timer with reload mode. It uses the timer to create
// an interrupt at a certain rate and when the user's interrupt counter
// reaches the selected value the LED (P0.2)is toggled.
//
//
// Pinout:
//
