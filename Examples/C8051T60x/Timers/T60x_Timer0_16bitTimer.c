...
// 16-bit counter/timer mode. In this example the LED is toggled at a
...
// How To Test:
//
// 1) Open the T60x_Timer0_16bitTimer.c file in the Silicon Labs IDE.
...
#define AUX2     -(TIMER_TICKS_PER_MS*LED_TOGGLE_RATE)
