...
// 2) Download code to a 'T60x device that is connected to a SMBus slave.
// 3) Run the code:
...
// TEST CODE-------------------------------------------------------------------
   ...
   while (1)
   {
      ...
      T0_Wait_ms (50);                 // Wait 50 ms so user can see blinking
   }
...
void PORT_Init (void)
{
   ...
   XBR0 = 0x0F;                        // Skip P0.0-P0.3 to shift SMBus
