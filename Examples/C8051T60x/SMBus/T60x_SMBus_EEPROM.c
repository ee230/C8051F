...
// Program Description:
//
// This example demonstrates how the C8051T60x SMBus interface can communicate
...
// 2) Download code to a 'T60x device that is connected to a 24LC02B serial
...
void EEPROM_WriteArray(U8 dest_addr, U8* src_addr,
                       U8 len);
unsigned char EEPROM_ByteRead(U8 addr);
