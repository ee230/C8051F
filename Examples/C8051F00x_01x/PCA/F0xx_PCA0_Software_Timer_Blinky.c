...
// How To Test:
//
// 1) Download code to a 'F0xx target board with the LED jumper ON.
...
#define T0_CLOCKS 160                  // Use 160 clocks per T0 Overflow
...
void Port_Init (void)
{
   ...
   PRT1CF |= 0x40;                     // Set LED (P1.6) to push-pull
}
...
// SYSCLK is set up for the internal oscillator running at 16 MHz.
