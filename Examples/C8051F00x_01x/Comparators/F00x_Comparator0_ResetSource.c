...
// spins in an infinite while() loop.  If the button on P1.7 (on the target
...
// How To Test:
//
// 1) Compile and download code to a 'F005 target board
// 2) On the target board, connect CP0+ to P1.6 and CP0- to P1.7
//    These pins are available on the J2 header
//    CP0+ : pin 54
//    P1.6 : pin 3
//    CP0- : pin 52
//    P1.7 : pin 4
// 3) Run the code an verify that the LED is on
// 4) Press the P1.7 switch (this causes a comparator reset)
...
void PORT_Init (void)
{
   ...
   PRT1CF  |= 0x40;                    // LED is push-pull a output
}
