...
// Program Description:
//
// This program configures a C8051F0xx as a 4-wire SPI Single Master.
//
...
// How To Test:
//
// 1) Download the code to a F005-TB that is connected as above to
...
void PORT_Init (void)
{
   PRT0CF = 0x85;                      // Make SCK, MOSI, and SLAVE_SEL
                                       // push-pull
   PRT1CF = 0x40;                      // Make the LED push-pull
