...
// Program Description:
//
// Example software to demonstrate the C8051F0xx SMBus interface in
...
//      - the 'F0xx SMBus master should detect any conflict using ARBLOST
//      - the 'F0xx SMBus master should give up the bus, if necessary, and
//        switch to slave receiver mode
//      - the 'F0xx SMBus master should transmit after the other master is done
// - Pinout:
//    P0.0 -> SDA (SMBus)
//    P0.1 -> SCL (SMBus)
//
...
// How To Test:
//
// 1) Download code to a 'F0xx device that is connected to another C8051Fxxx
//    SMBus multimaster.
...
//
//      'F0xx Multimaster                     Other C8051Fxxx Multimaster
//         LED (blinks) <------------------------------ Switch
//              SW --------------------------------> LED (blinks)
//
...
// P1.7   digital   open-drain    SW (switch)
//
// all other port pins unused
//
