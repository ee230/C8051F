...
// How To Test:
//
// 1) Compile and download code to a 'F30x target board
// 2) On the target board, connect P0.0 to P0.3 and P0.1 to P0.2
// 3) Run the code and verify that the LED is on
// 4) Press the P0.3 switch (this causes a comparator reset)
...
sbit LED    = P0^2;                    // Green Led
sbit SWITCH = P0^3;                    // Push-button switch on board
