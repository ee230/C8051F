...
// Program Description:
//
// This program flashes the Red LED on the C8051F960 target board about
// five times a second using the interrupt handler for Timer2.
//
//
// How To Test:
//
// 1) Check the Hardware definition for your particular hardware.
// 1) Download code to the 'F96x target board
// 2) Run the program.  If the Red LED flashes, the program is working
//
//
