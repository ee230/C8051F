...
// loop.  If the button on P0.0 (on the target board) is pressed, then the
// edge-triggered /INT0 input on P0.0 will cause an interrupt and toggle
// LED3. If the button on P0.1 is pressed, then the edge-triggered
...
// How To Test:
//
// 1) Compile and download code to a 'F960 target board.
// 1) Download code to the UDP F960 MCU MUX LCD board.
