...
// How To Test:
//
// 1) Open the F336_Timer0_13bitExtTimer.c file in the Silicon Labs IDE.
...
#include <C8051F336_defs.h>            // SFR declaration
...
SBIT (SIGNAL, SFR_P1, 7);              // SIGNAL is used to input pulses into
                                       // T0 pin
SBIT (BUTTON1, SFR_P0, 7);             // Button that enables counting
