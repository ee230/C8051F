...
--*/
{
    ...
    case IRP_MN_STOP_DEVICE:
        ...
        KdPrint( ("BulkUsb_DispatchPnP::IRP_MN_STOP_DEVICE::"));
    ...
    case IRP_MN_SURPRISE_REMOVAL:
        ...
        KdPrint( ("BulkUsb_DispatchPnP::IRP_MN_SURPRISE_REMOVAL::"));
        BulkUsb_IoDecrement(deviceExtension);
    ...
    default:
        ...
        KdPrint( ("BulkUsb_DispatchPnP::default::"));
        BulkUsb_IoDecrement(deviceExtension);
...
--*/
{
    ...
    KdPrint( ("HandleQueryStopDevice - ends\n"));
...
--*/
{
    ...
    KdPrint( ("HandleCancelStopDevice - begins\n"));
    ...
    KdPrint( ("HandleCancelStopDevice - ends\n"));
