...
void Adc_Init(void)
{
   ...
   AMX0P = 0x0D;                       // Switch to potentiometer (P2.5)
...
// P2.2   digital output  LED1, PCA channel 0 (CEX0)
// P2.3   digital output  LED2, PCA channel 1 (CEX1)
//
// P2.5   analog input    potentiometer
//
//-----------------------------------------------------------------------------
void Port_Init(void)
{
...
// Parameters - None
//
// Timer 2 reload, used to check if switch pressed on overflow and used to
// trigger ADC0 conversions.
//
//-----------------------------------------------------------------------------
void Timer2_Init(void)
{
