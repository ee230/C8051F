...
//
// When J6 is shorted, the potentiometer (R14) wiper is connected to P1.2.
//
...
// How To Test:
// ------------
// 1) Download code to a 'F80x device on a C8051F80x-TB development board
...
// 5) Ensure that jumpers are placed on J6 and J7.
