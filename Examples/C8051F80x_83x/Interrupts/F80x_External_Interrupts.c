...
// How To Test:
//
// 1) Compile and download code to a 'F80x target board.
// 2) On the target board, connect P1.4_SW signal on J3 to P0.0
...
void Ext_Interrupt_Init (void);        // Configure External Interrupts (/INT0
                                       // and /INT1)
INTERRUPT_PROTO(Ext_Interrupt0_ISR, INTERRUPT_INT0);
