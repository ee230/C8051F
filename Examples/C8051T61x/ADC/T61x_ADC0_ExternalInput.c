...
// as Vdd is set by the regulator on the board, not the C8051T610.
//
...
// How To Test:
// ------------
// 1) Download code to a 'T610 device on a C8051T610-TB development board
...
#define VDD_SUPPLY   3360              // Vdd supply voltage in mV
...
void PORT_Init (void)
{
   ...
   P0MDOUT |= 0x11;                    // Set P0.0, TX pins to push-pull
...
void ADC0_Init (void)
{
   ...
   REF0CN = 0x08;                      // Enable on-chip VREF, select Vdd as 
                                       // voltage reference. 
