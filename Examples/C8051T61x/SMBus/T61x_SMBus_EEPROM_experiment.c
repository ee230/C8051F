...
// Program Description:
//
// This example demonstrates how the C8051T61x SMBus interface can communicate
...
// - Pinout:
//    P0.0 -> SDA (SMBus) (Pull-up Resistor required at EEPROM) - TEST - P0.2
//    P0.1 -> SCL (SMBus) (Pull-up Resistor required at EEPROM) - TEST - P0.3
//
//    P3.0 -> C2D (debugging interface)
//
//    P1.0 -> LED (on the 'T610 TB)
//
//    all other port pins unused
//
// How To Test:
//
// 1) Download code to a 'T61x device that is connected to a 24LC02B serial
...
SBIT (SDA, SFR_P0, 4);                 // SMBus on P0.0
SBIT (SCL, SFR_P0, 5);                 // and P0.1
...
void main (void)
{
   ...
   while(!SDA)
   {
      ...
      P0SKIP = 0x03;  //TEST - SKIP P0.0 AND P0.1
