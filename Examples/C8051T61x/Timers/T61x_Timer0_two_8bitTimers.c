...
// Program Description:
//
// This program presents an example of use of the Timer0 of the C8051T61x's in
...
// How To Test:
//
// 1) Open the T61x_Timer0_two_8bitTimers.c file in the Silicon Labs IDE.
...
void Port_Init (void)
{
   ...
   P1MDOUT = 0x03;                     // Set LED and SIGNAL to
