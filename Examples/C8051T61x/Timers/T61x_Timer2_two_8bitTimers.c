...
// Program Description:
//
// This program presents an example of use of the Timer2 of the C8051T61x's in
// two 8-bit reload counter/timer mode. It uses the 'T610DK as HW platform.
//
...
// How To Test:
//
// 1) Open the T61x_Timer2_two_8bitTimers.c file in the Silicon Labs IDE.
...
void Port_Init (void)
{
   ...
   P1MDOUT = 0x03;                     // Set LED and SIGNAL to Push Pull
