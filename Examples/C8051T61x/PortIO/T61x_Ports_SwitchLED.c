...
// and outputs.  The C8051T610 target board has one push-button switch
...
// How To Test:
//
// 1) Download code to a 'T610 target board
// 2) Ensure that the Switch and LED pins on the J9 header are 
//    properly shorted
...
SBIT (LED1, SFR_P1, 0);                // LED==1 means ON
