...
// 2) Compile and download code to a 'T61x device.
// 3) Connect the CMOS input clock to EXTCLK / P0.3 
// 4) Run the code:
//      - the test will blink an LED at a frequency based on the CMOS
//         Oscillator
//      - the 'T61x will also output the SYSCLK to a port pin (P0.0) for
//         observation
//
//
// FID:            31X000009
...
// should be wired to the EXTCLK pin as shown in Option 1, 2, or 3 in the
