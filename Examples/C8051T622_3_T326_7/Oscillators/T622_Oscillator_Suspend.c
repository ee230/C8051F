...
// 'T622/3 and 'T326/7. The MCU will sleep in low power suspend mode and wait
// until a switch is pressed. When the MCU wakes up it will switch to a 12 MHz
...
// 2) Make sure J10 has a jumper connecting the LED to P1.2.
// 3) Make sure J9 has a jumper connecting SW2 to P1.0.
// 4) Run the code.
...
//
// Release 1.1
//    -Modified comments in Port_Init function (ES)
//    -14 JAN 2009
//
// Release 1.0
//    -Initial Revision (TP)
...
SBIT (LED, SFR_P1, 2);                 // Port pin used for LED
...
//
// P1.0   open-drain   input    port-match input and SW2
//
...
void Port_Init ()
{
   ...
   P1MDOUT |= 0x04;                    // Enable P1.2 as push-pull
