...
//    C8051T622 daughter card.
// 2) Specify the target frequency in the constant <RC_FREQUENCY>.
// 3) Download code to a 'T622 device using the 'T622 daughter card and 'T62x
//    mother board.
...
// expected RC_FREQUENCY is 41 kHz. The actual measured frequency
// on the target board was 39.5 kHz.
//
//
...
// Release 1.0
//    -Initial Revision (TP)
//    -Modified example calculation numbers (ES)
//    -02 SEP 2008
//
