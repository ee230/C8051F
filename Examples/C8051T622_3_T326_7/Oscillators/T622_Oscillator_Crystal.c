...
//    capacitors (C5 and C6) are installed on the C8051T622 daughter card.
// 2) Specify the crystal frequency in the constant <CRYSTAL_FREQUENCY>.
// 3) Download code to an 'T622 device using the 'T62x mother board.
