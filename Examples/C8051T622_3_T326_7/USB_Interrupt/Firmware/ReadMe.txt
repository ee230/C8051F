...
1) Download the code to any C8051T622/3 or 'T326/7 device on a 'T62x mother 
   board using the Silicon Labs IDE
...
5)  Because of the locations of the switches and LEDs, the upper P1 pins
    will be used for GPIO0-2.  For example, GPIO0 in the PC application
    refers to P1.4.  The "Bit 3" in the application is not used.
...
T622_USB_Descriptor.c
T622_USB_Descriptor.h
T622_USB_ISR.c
T622_USB_Main.c
T622_USB_Main.h
T622_USB_Register.h
T622_USB_Standard_Requests.c
