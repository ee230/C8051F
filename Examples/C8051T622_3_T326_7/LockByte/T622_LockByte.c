...
// Program Description:
//
// The program blinks an LED and sets the value of the Lock Byte.  The 'T622/3
// and 'T326/7 Security Lock Byte write and read locks the EPROM memory.  If
// any of the write lock bits (7-4) or read lock bits (3-0) are cleared, the
// entire EPROM memory will be write or read locked.
//
...
//
// This program is part of the "T622_LockByte" project.
//
// How To Test:
//
