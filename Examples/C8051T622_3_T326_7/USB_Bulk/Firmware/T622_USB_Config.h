...
#ifndef  T622_USB_CONFIG_H
#define  T622_USB_CONFIG_H
...
//
// By default, EP1 is IN and EP2 is OUT.  Only EP1 is double buffered.

#define EP0_MAXP       64              // Endpoint0 maximum packet size
#define EP1_IN_MAXP    64              // Endpoint1 IN maximum packet size
#define EP2_IN_MAXP    64              // Endpoint2 IN maximum packet size
