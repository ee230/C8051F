...
// firmware running on the device.  For the 'T622, the file is limited to
...
// the application-specific code is included in the "T622_USB_Main.c" and
// "T622_USB_ISR.c" files.
//
...
SBIT (LED2, SFR_P1, 2);                // Blink to indicate data transmission
...
void Port_Init(void)
{
   P0MDOUT |= 0x40;                    // Port 0.6 set to push-pull
   P1MDOUT |= 0x04;                    // Port 1.2 set to push-pull
