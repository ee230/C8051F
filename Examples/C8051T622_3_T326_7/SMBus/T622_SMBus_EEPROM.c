...
// Program Description:
//
// This example demonstrates how the C8051T622/3 and 'T326/7 SMBus interface
...
//    to a 24LC02B serial EEPROM (see the EEPROM datasheet for the pinout
//    information).
...
void main (void)
{
   ...
   // Set internal oscillator to 12 MHz
   OSCICN |= 0x03;
