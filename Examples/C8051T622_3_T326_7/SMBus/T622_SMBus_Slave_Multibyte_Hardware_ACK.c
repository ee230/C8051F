//-----------------------------------------------------------------------------
// T622_SMBus_Slave_Multibyte_Hardware_ACK.c
//-----------------------------------------------------------------------------
...
// Program Description:
//
// Example software to demonstrate the C8051T622/3 or 'T326/7 SMBus interface
...
void SMBus_Init (void)
{
   SMB0CF = 0x08;                      // Use Timer1 overflows as SMBus clock
                                       // source;
                                       // Enable slave mode;
...
// Supported SMBus Frequencies range from 10kHz to 400kHz.  The CKCON register
