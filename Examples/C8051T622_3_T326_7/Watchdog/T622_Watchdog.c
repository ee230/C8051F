...
//         (P1.0) is pressed.
//       - Once the the switch (SW2) is pressed and held for a long enough
//         time, it will cause a WDT reset.
...
// It also sets the offset value by writing to PCA0CPL2.
//
//-----------------------------------------------------------------------------
void PCA0_Init()
{
...
//
// P1.0   digital   open-drain    SW2 (switch)
//
