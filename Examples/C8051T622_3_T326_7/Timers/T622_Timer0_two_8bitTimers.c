...
// two 8-bit reload counter/timer mode. It uses the 'T622 daughter card and
...
//
//    P1.2 -> LED2 (toggled by TH0)
//
//    all other port pins unused
//
// How To Test:
//
// 1) Open the T622_Timer0_two_8bitTimers.c file in the Silicon Labs IDE.
...
SBIT (LED2, SFR_P1, 2);                // LED2 to be used also by Timer0
...
void Port_Init (void)
{
   ...
   P0MDOUT |= 0x40;                    // Set P0.6 (LED1) to push-pull
   P1MDOUT |= 0x04;                    // Set P1.2 (LED2) to push-pull
}
