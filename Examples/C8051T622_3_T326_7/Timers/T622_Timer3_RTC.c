...
//
// Option1:
// 1) Open the T622_Timer3_RTC.c file in the Silicon Labs IDE.
// 2) Populate the Y1 crystal with a 32.768 kHz crystal, R2 with a 10 Mohm
//    resistor, and C5 and C6 appropriately (to match the crystal) on the 'T622
//    daughter card.
// 3) Remove the R4 and R3 resistors on the 'T622 daughter card.
// 4) Compile the project.
// 5) Download code to a 'T622 device on a 'T62x mother board.
// 6) Verify the P1.2 LED pin of J10 is populated on the 'T62x MB.
// 7) Run the code.
...
// 9) Download code to a 'T622 device on a 'T62x mother board.
...
void Port_Init (void)
{
   ...
   P1MDOUT |= 0x04;                    // Set P1.2 (LED) to push-pull
