...
//
// How To Test:
// 1) Download code to a 'T622 device in the 'T622 daughter card with P0.0 and
//    P0.1 tied together on the 'T62x mother board.
// 2) Remove the P0.1 switch jumper (J9).
// 3) Run the program for a few seconds, and then halt.
// 4) Verify that the variable "capture_period" is equal to 50 (=500us).
//
// Alternately:
