//-----------------------------------------------------------------------------
// T622_PCA0_Software_Timer_Blinky.c
//-----------------------------------------------------------------------------
...
// How To Test:
//
// 1) Download code to a 'T622 device in a 'T622 daughter card.
// 2) Populate the P1.2 LED jumper (J10) on the 'T62x mother board.
...
void Port_Init (void)
{
   ...
   P1MDOUT |= 0x04;                    // Set LED (P1.2) to push-pull
}
