...
// Program Description:
//
// This program uses all the functions available in T622_EPROM_Primitives.c
// and T622_EPROM_Utils.c.  It uses a test data array to mimic the changes
...
// 'T622/3 and 'T326/7.  In order to use this functionality, the capacitor on
// the VPP pin, C7, must be populated on the 'T622 daughter card.
//
// Pinout:
//
//    P2.2 -> LED
...
//
// Option 1:
// 1) Load the T622_EPROM.c, T622_EPROM_Primitives.c, and T622_EPROM_Utils.c
//    files in the Silicon Labs IDE.
// 2) Populate the C7 capacitor on the 'T622 daughter card.
// 3) Compile and download code to a 'T622/3 device using a 'T622 daughter card
...
void Port_Init (void)
{
   P1MDOUT = 0x04;                     // Set LED as push-pull

   P1SKIP |= 0x04;                     // Skip LED
