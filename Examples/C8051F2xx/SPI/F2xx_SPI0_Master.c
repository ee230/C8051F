...
// Program Description:
//
// This program configures a C8051F2xx as a 4-wire SPI Single Master.
//
...
//
// P2.7 - SLAVE_SEL  (digital output, push-pull) This pin should be routed
//        to NSS on the slave (J2 - pin 20)
//
...
sbit SLAVE_SEL = P2^7;                 // Slave select pin (NSS)
...
// P2.2  -  MOSI (SPI0), Push-Pull,  Digital
// P2.3  -  NSS  (SPI0), Open-Drain, Digital
// P2.4  -  LED,         Push-Pull,  Digital (LED D3 on Target Board)
//
// P2.7  -  SLAVE_SEL,   Push-Pull,  Digital
//
//-----------------------------------------------------------------------------
void PORT_Init (void)
{
   PRT2CF = 0x95;                      // Make SCK and MOSI push-pull
                                       // Make SLAVE_SEL and the LED push-pull
