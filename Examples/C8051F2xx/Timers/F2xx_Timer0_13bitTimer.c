...
// in 13-bit counter/timer mode. It uses the 'F2xxDK as HW platform and blinks
...
// (SYSCLK, in this case the internal oscillator @16MHz/8) with a 1:12
// prescaler.
// The interrupt routine then toggles the LED. To execute the test please
// follow these steps:
//
// 1) Open the F2xx_Timer0_13bitTimer.c file in the Silicon Labs IDE.
