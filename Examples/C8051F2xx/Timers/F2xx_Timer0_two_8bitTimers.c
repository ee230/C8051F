...
// two 8-bit counter/timer mode. It uses the 'F200DK as HW platform.
//
...
// Pinout:
//
//    P2.4 - LED (toggled by TL0) (pin 21 on the 'F005 TB)
//    P2.7 - SIGNAL output (toggled by TH0) (pin 20 on the 'F005 TB)
//
//    all other port pins unused
//
// How To Test:
//
// 1) Open the F2xx_Timer0_two_8bitTimers.c file in the IDE
...
sbit SIGNAL = P2^7;                    // SIGNAL to be used also by Timer0
...
//
//    P2.4 - LED (toggled by TL0)
//    P2.7 - SIGNAL output (toggled by TH0)
//
//    all other port pins unused
//
//-----------------------------------------------------------------------------
void Port_Init (void)
{
   PRT2CF = 0x90;                      // Set LED and SIGNAL to
