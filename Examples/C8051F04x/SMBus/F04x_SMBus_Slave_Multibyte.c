...
// Program Description:
//
// Example software to demonstrate the C8051F04x SMBus interface in Slave mode
...
// How To Test:
//
// 1) Download code to a 'F04x device that is connected to a SMBus master.
