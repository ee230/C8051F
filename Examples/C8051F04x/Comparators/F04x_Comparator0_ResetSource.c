...
// How To Test:
//
// 1) Compile and download code to a 'F04x target board
// 2) On the target board, connect P2.6 to P3.7 and P2.7 to P1.6
...
// P2.6   digital   push-pull     Comparator + Input
// P2.7   digital   open-drain    Comparator - Input
...
// Parameters   : None
//
//  This function configures the comparator to pins P2.6 and P2.7
//-----------------------------------------------------------------------------
...
void Comparator0_Init (void)
{
   ...
   CPT0CN = 0x83;                      // Comparator0 enabled
									   ...
									   // Comparator0 defaults to P2.6 & P2.7
