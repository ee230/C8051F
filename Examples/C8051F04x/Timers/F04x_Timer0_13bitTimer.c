...
// Program Description:
//
// This program presents an example of use of the Timer0 of the C8051F04x's
// in 13-bit counter/timer mode. It uses the 'F040DK as HW platform and blinks
...
// follow these steps:
//
// 1) Open the F04x_Timer0_13bitTimer.c file in the Silicon Labs IDE.
// 2) If a different LED blink rate is required change the following constant:
//       -> LED_TOGGLE_RATE in milliseconds
// 3) Compile and download the code in a F040DK board
...
// the LED . In this example the value of the 5 LSB of the counter are not
// being updated.
//
