...
// Program Description:
//
// This program configures a C8051F36x as a 4-wire SPI Single Master.
//
...
// How To Test:
//
// 1) Download the code to a F360-TB that is connected as above to
//    another device running the SPI0_Slave code.
// 2) Verify the LED pins of jumper J12 are populated.
// 3) Verify J15 is not populated.
// 4) Run the code.
