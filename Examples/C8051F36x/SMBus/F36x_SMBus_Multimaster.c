...
//    P3.2 -> LED
//
//    P4.6 -> C2D (debug interface)
//
//    all other port pins unused
//
// How To Test:
//
// 1) Verify that MY_ADDR and MULTI_ADDR are defined to the proper values.
// 2) Download code to a 'F36x device that is connected to another C8051Fxxx
//    SMBus multimaster.
...
sbit SW = P3^0;                        // Switch on P3.0

sbit LED = P3^2;                       // LED on port P3.2
