...
// savings mode operation on the T63x. The MCU will sleep in low power idle
...
// 2) Ensure that the P1.3 LED shorting block is in place on the J9 header.
// 3) Run the code.
// 4) The P1.3 LED should blink once a second.
//
//
// Target:         C8051T63x
// Tool chain:     Generic
