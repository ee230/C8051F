...
// Program Description:
//
// This program accesses a SPI EEPROM using polled mode access. The 'T630 MCU
...
// connections of the 'T630 MCU are shown here:
//
...
//
// Method1:
// 1) Download the code to a 'T630 device that is connected as above.
...
//
// Method2 (optional):
// 1) Download code to a 'T630 device that is connected as above
