...
// Program Description:
//
// This program presents an example of use of the Timer0 of the C8051T630 in
// 8-bit counter/timer with reload mode. It uses the 'T630DK as HW platform.
...
// How To Test:
//
// 1) Load the T630_Timer0_8bitReloadTimer.c file in the Silicon Labs IDE.
// 2) If a different LED blink rate is required change the following constant:
//       -> LED_TOGGLE_RATE in milliseconds
// 3) Compile and download code to a 'T630 device
