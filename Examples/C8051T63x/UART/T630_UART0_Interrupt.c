...
// Program Description:
//
// This program demonstrates how to configure the C8051T630 to write to and read
// from the UART interface. The program reads a word using the UART interrupts
// and outputs that word to the screen, with all characters in uppercase
//
// How To Test:
//
// 1) Ensure that jumpers are placed on J3 of the C8051T630 target board
...
// 5) Download and execute code on an 'T630 target board
