...
// Program Description:
//
// This example demonstrates how the C8051T630 SMBus interface can communicate
...
// How To Test:
//
// 1) Verify that J5 is not populated.
// 2) Download code to a 'T630 device that is connected to a 24LC02B serial
