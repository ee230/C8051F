...
// two 8-bit reload counter/timer mode. It uses the 'F326DK as HW platform.
//
...
// reaching the value defined by LED2_TOGGLE_RATE toggles the LED2
//
// Pinout:
//
...
// How To Test:
//
// 1) Open the F326_Timer0_two_8bitTimers.c file in the Silicon Labs IDE.
// 2) If desired, change the number of interrupts (ms) to toggle an output:
//    LED1_TOGGLE_RATE
//    LED2_TOGGLE_RATE
// 3) Compile and download the code.
// 4) Verify the LED pins of J3 are populated on the 'F326 TB.
// 5) Run the code.
