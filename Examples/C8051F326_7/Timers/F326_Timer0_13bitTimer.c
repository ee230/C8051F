...
// in 13-bit counter/timer mode. It uses the 'F326DK as HW platform and blinks
...
// follow these steps:
//
// 1) Open the F326_Timer0_13bitTimer.c file in the Silicon Labs IDE.
// 2) If a different LED blink rate is required change the following constant:
//       -> LED_TOGGLE_RATE in milliseconds
// 3) Compile and download the code to a 'F326/7
